  ...
  return (
    ...
    >
      ...
      <Box>
        ...
        {isEditing ? (
          <Tooltip
            title="Ward will be automatically updated based on address when saved."
            placement="top"
          >
            <span>{renderField("ward", "textarea")}</span>
          </Tooltip>
        ) : (
      ...
      <Box>
        ...
        {isEditing ? (
          ...
          <Typography variant="body1" sx={{ fontWeight: 600 }}>
            {selectedCaseWorker
              ? selectedCaseWorker.name === "None" && selectedCaseWorker.organization === "None"
                ? "None"
                : [
                    selectedCaseWorker.name,
                    selectedCaseWorker.organization,
                  ]
                    .filter(Boolean)
                    .join(
