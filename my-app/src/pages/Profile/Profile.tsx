        ...
        try {
          ...
          if (!querySnapshot.empty) {
            ...
            if (latestEndDateString) {
              ...
              // Update the client document with the new last delivery date
              await updateDoc(clientRef, { lastDeliveryDate: latestEndDateString });
            } else {
              ...
              setLastDeliveryDate(deliveryDateStr);
              await updateDoc(clientRef, { lastDeliveryDate: deliveryDateStr });
            }
          } else {
