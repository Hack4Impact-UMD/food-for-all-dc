...
const Spreadsheet: React.FC = () => {
  ...
  const handleAddRow = async () => {
    try {
      ...
      // new client profile with provided fields for now
      const clientData = {
      ...
      let docRef;
      if (newRow.uid) {
        // if uid id provided use it as uid
        docRef = doc(db, "clients", newRow.uid);
        await setDoc(docRef, {
          ...clientData,
          uid: newRow.uid,
        });
      } else {
        // if not then use firebase autogenerated uid
        const clientsRef = collection(db, "clients");
        docRef = await addDoc(clientsRef, clientData);
      }
      ...
      // TODO?: redirect to new client profile
    } catch (error) {
