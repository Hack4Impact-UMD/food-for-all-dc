...
describe("ClientService", () => {
  ...
  describe("getAllClients", () => {
    ...
    it("should throw on Firestore error", async () => {
      jest
        ...
        .mockRejectedValueOnce(new Error("Failed to get all clients"));
  ...
  describe("getClientById", () => {
    ...
    it("should throw on Firestore error", async () => {
      jest
        ...
        .mockRejectedValueOnce(new Error("Failed to get client by ID"));
  ...
  describe("updateClient", () => {
    ...
    it("should throw on Firestore error", async () => {
      jest
        ...
        .mockRejectedValueOnce(new Error("Failed to update client"));
  ...
  describe("deleteClient", () => {
    ...
    it("should throw on Firestore error", async () => {
      jest
        ...
        .mockRejectedValueOnce(new Error("Failed to delete client"));
  ...
  describe("updateClientCluster", () => {
    ...
    it("should throw on Firestore error", async () => {
      jest
        .spyOn(service, "updateClientCluster")
        .mockRejectedValueOnce(new Error("Failed to update cluster for client id"));
      await expect(service.updateClientCluster("id", "cluster")).rejects.toThrow(
        "Failed to update cluster for client id"
      );
    });
  });
  ...
  describe("updateClientCoordinates", () => {
    it("should throw if clientId is missing", async () => {
      jest
        .spyOn(service, "updateClientCoordinates")
        .mockRejectedValueOnce(new Error("Client ID is required"));
      await expect(service.updateClientCoordinates("", [0, 0])).rejects.toThrow(
    ...
    it("should throw if coordinates are invalid", async () => {
      ...
      await expect(service.updateClientCoordinates("id", null as any)).rejects.toThrow(
        "Invalid coordinates"
      );
    });
    it("should resolve on success", async () => {
