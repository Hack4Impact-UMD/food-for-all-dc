...
describe("DeliveryService", () => {
  ...
  describe("getAllEvents", () => {
    ...
    it("should throw on Firestore error", async () => {
      jest
        ...
        .mockRejectedValueOnce(new Error("Failed to get all events"));
  ...
  describe("setDailyLimit", () => {
    ...
    it("should throw on Firestore error", async () => {
      ...
      await expect(service.setDailyLimit("2024-01-01", 10)).rejects.toThrow(
  ...
  describe("updateWeeklyLimits", () => {
    ...
    it("should throw on Firestore error", async () => {
      ...
      await expect(service.updateWeeklyLimits({})).rejects.toThrow(
        "Failed to update weekly limits"
      );
    });
  });
  ...
  describe("getClientDeliveryHistory", () => {
    it("should return an object with pastDeliveries and futureDeliveries", async () => {
      jest
        .spyOn(service, "getClientDeliveryHistory")
        .mockResolvedValueOnce({ pastDeliveries: [], futureDeliveries: [] });
