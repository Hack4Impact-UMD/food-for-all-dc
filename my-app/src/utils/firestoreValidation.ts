...
export function validateClientProfile(data: any): data is ClientProfile {
  return !!data && typeof data.uid === 'string' && typeof data.name === 'string' && isValidEmail(data.email);
}

export function validateDriver(data: any): data is Driver {
  return !!data && typeof data.id === 'string' && typeof data.name === 'string' && isValidPhone(data.phone);
}
...
export function validateAuthUserRow(data: any): data is AuthUserRow {
  return !!data && typeof data.id === 'string' && typeof data.name === 'string' && isValidEmail(data.email);
}
