...
geocode_fn = https_fn.on_request(region="us-central1")(geocode_addresses_endpoint)
k_medoids_fn = https_fn.on_request(region="us-central1")(cluster_deliveries_k_medoids)
k_means_fn = https_fn.on_request(region="us-central1")(cluster_deliveries_k_means)
